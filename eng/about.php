...
<head>
    ...
    <title>About <?php include('eng/title.html'); ?></title>
</head>
...
<body id="bg-img">
    ...
    <main id="about">
        ...
        <p>The References page houses the websites I've made or worked on, which saw the light of day.</p>
        <p>If you whish to contact me, visit the Contact page, where I also put my social network and other links as well.</p>
